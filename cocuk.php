<?php
    ...
    if ($siralama == 'za') $kitaplar = "SELECT * FROM kitaplar WHERE kategori = 'cocuk' ORDER BY kitapadi DESC";
    else if ($siralama == 'azFiyat') $kitaplar = "SELECT * FROM kitaplar WHERE kategori = 'cocuk' ORDER BY fiyat ASC";
    else if ($siralama == 'cokFiyat') $kitaplar = "SELECT * FROM kitaplar WHERE kategori = 'cocuk' ORDER BY fiyat DESC";
    else $kitaplar = "SELECT * FROM kitaplar WHERE kategori = 'cocuk' ORDER BY kitapadi ASC";
