...
// Yayın Adı Seçimi
$yayın_adi = ["Can Yayınları", "Yapı Kredi Yayınları", "İletişim Yayınları", "Everest Yayınları", "Doğan Kitap", "Kırmızı Kedi Yayınevi", "İthaki Yayınları", "Sel Yayıncılık", "Alfa Yayınları", "Türkiye İş Bankası Kültür Yayınları"];

// Fotoğraf Seçimi (downloaded_images klasöründeki tüm fotoğraflar)
$foto_klasor = 'downloaded_images/roman/';
